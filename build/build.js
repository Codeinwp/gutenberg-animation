...
/***/ "./src/components/animation-popover.js":
/*!*********************************************!*\
  !*** ./src/components/animation-popover.js ***!
  \*********************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _data_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../data.js */ \"./src/data.js\");\nfunction _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest(); }\n\nfunction _nonIterableRest() { throw new TypeError(\"Invalid attempt to destructure non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); }\n\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(o); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\n\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\n\nfunction _iterableToArrayLimit(arr, i) { if (typeof Symbol === \"undefined\" || !(Symbol.iterator in Object(arr))) return; var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i[\"return\"] != null) _i[\"return\"](); } finally { if (_d) throw _e; } } return _arr; }\n\nfunction _arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }\n\n\nvar __ = wp.i18n.__;\nvar _wp$components = wp.components,\n    BaseControl = _wp$components.BaseControl,\n    Button = _wp$components.Button,\n    Popover = _wp$components.Popover,\n    TextControl = _wp$components.TextControl;\nvar _wp$element = wp.element,\n    Fragment = _wp$element.Fragment,\n    useState = _wp$element.useState;\n\nfunction AnimationPopover(_ref) {\n  var animationsList = _ref.animationsList,\n      updateAnimation = _ref.updateAnimation,\n      currentAnimationLabel = _ref.currentAnimationLabel,\n      setCurrentAnimationLabel = _ref.setCurrentAnimationLabel;\n\n  var _useState = useState(false),\n      _useState2 = _slicedToArray(_useState, 2),\n      isVisible = _useState2[0],\n      setIsVisible = _useState2[1];\n\n  var _useState3 = useState(''),\n      _useState4 = _slicedToArray(_useState3, 2),\n      currentInput = _useState4[0],\n      setCurrentInput = _useState4[1];\n\n  var _useState5 = useState(false),\n      _useState6 = _slicedToArray(_useState5, 2),\n      animationFound = _useState6[0],\n      setAnimationFound = _useState6[1];\n\n  var getAnimations = function getAnimations(animation) {\n    var match = true;\n\n    if (currentInput) {\n      var inputWords = currentInput.toLowerCase().split(' ');\n      inputWords.forEach(function (word) {\n        if (!animation.label.toLowerCase().includes(word)) {\n          match = false;\n        }\n      });\n    }\n\n    if (match && !animationFound) {\n      setAnimationFound(true);\n    }\n\n    return match && wp.element.createElement(Button, {\n      onClick: function onClick() {\n        setCurrentAnimationLabel(animation.label);\n        setIsVisible(false);\n        updateAnimation(animation.value);\n      }\n    }, animation.label);\n  };\n\n  return wp.element.createElement(BaseControl, {\n    label: \"Animation\"\n  }, wp.element.createElement(Button, {\n    isSecondary: true,\n    className: \"animationButton\",\n    onClick: function onClick() {\n      setIsVisible(!isVisible);\n    }\n  }, currentAnimationLabel), isVisible && wp.element.createElement(Popover, {\n    className: \"themeisle-animationPopover\",\n    noArrow: true,\n    position: \"center\",\n    onFocusOutside: function onFocusOutside(e) {\n      'components-button animationButton is-secondary' !== e.relatedTarget.className ? setIsVisible(false) : '';\n    }\n  }, wp.element.createElement(TextControl, {\n    placeholder: \"Search animations\",\n    value: currentInput,\n    onChange: function onChange(e) {\n      setCurrentInput(e);\n      setAnimationFound(false);\n    }\n  }), animationsList.map(function (animation) {\n    return wp.element.createElement(Fragment, null, '' === currentInput ? _data_js__WEBPACK_IMPORTED_MODULE_0__[\"categories\"].map(function (category) {\n      return category.value === animation.value ? wp.element.createElement(\"div\", {\n        className: \"category\"\n      }, category.label) : '';\n    }) : '', wp.element.createElement(\"div\", {\n      className: \"\".concat(currentAnimationLabel === animation.label ? 'animation-is-selected' : '')\n    }, getAnimations(animation)));\n  }), !animationFound && wp.element.createElement(\"div\", null, __('No animations found'))));\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (AnimationPopover);\n\n//# sourceURL=webpack:///./src/components/animation-popover.js?");
...
/*!*********************!*\
  !*** ./src/data.js ***!
  \*********************/
/*! exports provided: animationsList, categories, outAnimation, delayList, speedList */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
